      ...
      <>
              ...
              <MDBCardBody>
                <div className="text-center">
                  <h2 className="h2-responsive mb-4">
                    MDB TABLE EDITOR PLUGIN
                  </h2>
                  <p>
                    React Bootstrap Table Editor is a lightweight plugin that
                    allows you to add, edit and remove rows.
                  </p>
                </div>
              </MDBCardBody>
            </MDBCol>
        ...
        <MDBContainer>
          <MDBRow center className="my-5">
            <MDBCol md="8">{this.props.children}</MDBCol>
          </MDBRow>
        </MDBContainer>
      </>
    );
