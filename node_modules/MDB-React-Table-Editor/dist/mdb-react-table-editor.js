...
function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      }, okLabel)), React__default.createElement(mdbreact.MDBModalBody, null, React__default.createElement("form", {
        onSubmit: this.submitForm
      }, columns.map(function (col) {
        return React__default.createElement(mdbreact.MDBInput, {
          key: col.field,
          label: col.label,
          name: col.field,
      ...
      }))), React__default.createElement(mdbreact.MDBModalFooter, null, React__default.createElement(mdbreact.MDBBtn, {
        color: "secondary",
        onClick: toggle
      }, cancelLabel), React__default.createElement(mdbreact.MDBBtn, {
        color: "primary",
...
var DeleteModal = function DeleteModal(_ref) {
  ...
  }, label)), React__default.createElement(mdbreact.MDBModalBody, null, React__default.createElement("p", {
    className: "text-center h5"
  }, desc)), React__default.createElement(mdbreact.MDBModalFooter, {
    className: "flex-center"
  }, React__default.createElement(mdbreact.MDBBtn, {
    color: "danger",
    onClick: action
  }, yes), React__default.createElement(mdbreact.MDBBtn, {
    color: "primary",
    onClick: toggle
  }, no)));
};
...
function (_Component) {
  ...
  _createClass(TableEditor, [{
    ...
    value: function render() {
      ...
      var Table = React__default.cloneElement(this.props.children, {
        data: data
      });
      return React__default.createElement("div", null, React__default.createElement("div", {
        ...
        rounded: true,
        size: "sm"
      }, this.props.addLabel, " ", React__default.createElement(mdbreact.MDBIcon, {
        icon: "plus"
      })), React__default.createElement(mdbreact.MDBBtn, {
        onClick: function onClick() {
        ...
        rounded: true,
        size: "sm"
      }, this.props.editLabel), React__default.createElement(mdbreact.MDBBtn, {
        onClick: this.toggleDelete,
        disabled: rowsLength < 1,
        color: "danger",
        rounded: true,
        size: "sm"
      }, this.props.deleteLabel, " ", React__default.createElement(mdbreact.MDBIcon, {
        icon: "times"
      }))), Table, this.state.modal && React__default.createElement(Modal, {
        columns: this.state.columns,
        rows: this.state.rows,
      ...
      }), this.state.delete && React__default.createElement(DeleteModal, {
